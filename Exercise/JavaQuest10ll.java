...
public class JavaQuest10ll {
  ...
  public static void main(String[] args) {
    ...
    int[] newArr = new int[my_array.length];    // my_array = newArr;
    for (int i = 0, k = 0; i < my_array.length; i++) { 
  if (i==indexPosition && k==indexPosition){
    newArr[k] = newValue;
    k++;
  continue;
  }
